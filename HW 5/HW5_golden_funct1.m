...
% 
function [alpha1,falpha1] = HW5_golden_funct1(x,search)
...
fa=HW5_func_multivar(x+a*search); n=1;
b=a+addx; fb=HW5_func_multivar(x+b*search);
   while (fb < fa), % the idea is to iterate until fb > fa in this case the minimum is in between a and b
     ...
     fb=HW5_func_multivar(x+b*search);
     n=n+1;
   end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tau = (3-sqrt(5))/2;
...
falpha1 = HW5_func_multivar(x+alpha1*search);
falpha2 = HW5_func_multivar(x+alpha2*search);
